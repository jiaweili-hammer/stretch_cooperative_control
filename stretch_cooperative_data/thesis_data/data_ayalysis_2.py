...
data = np.load('thesis_data_2.npy.npz')
...
n_lift = np.linspace(0,len(lift_1027),len(lift_1027))

f_1027_array = f_1027[50:]
f_1028_array = f_1028[50:]
v_1027_array = v_1027[50:]
v_1028_array = v_1028[50:]
...
ax5.plot(n_lift,lift_1027,label='1027')
ax5.set_xlabel('frame')
ax5.set_ylabel('position (m)')

fig6 = plt.figure()
ax6 = fig6.add_subplot(1,1,1)
ax6.plot(n_lift,lift_1028,label='1028')
